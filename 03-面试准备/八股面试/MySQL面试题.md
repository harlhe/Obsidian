---
title: "MySQL面试题"
source: "https://xiaolincoding.com/interview/mysql.html"
author:
  - "[[小林coding]]"
published: undefined
created: 2025-09-18
description: "全面的MySQL数据库面试题汇总，涵盖SQL基础、索引原理与优化、事务ACID特性、存储引擎比较、锁机制与并发控制、性能调优、主从复制架构、分库分表策略、查询优化、InnoDB与MyISAM对比、数据库设计范式等核心知识点。深入解析MySQL原理，适合后端开发者面试准备和数据库管理学习。"
tags:
  - "clippings"
---
